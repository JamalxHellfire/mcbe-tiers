...
const CountryAnalytics = () => {
  ...
  useEffect(() => {
    // Simulate country analytics data
    const simulatedData: CountryData[] = [
      { country: 'United States', countryCode: 'US', visits: 2847, percentage: 32.5, flag: '🇺🇸' },
      { country: 'United Kingdom', countryCode: 'GB', visits: 1923, percentage: 22.0, flag: '🇬🇧' },
      { country: 'Canada', countryCode: 'CA', visits: 1456, percentage: 16.6, flag: '🇨🇦' },
      { country: 'Australia', countryCode: 'AU', visits: 987, percentage: 11.3, flag: '🇦🇺' },
      { country: 'Germany', countryCode: 'DE', visits: 756, percentage: 8.6, flag: '🇩🇪' },
      { country: 'France', countryCode: 'FR', visits: 432, percentage: 4.9, flag: '🇫🇷' },
      { country: 'Netherlands', countryCode: 'NL', visits: 234, percentage: 2.7, flag: '🇳🇱' },
      { country: 'Sweden', countryCode: 'SE', visits: 123, percentage: 1.4, flag: '🇸🇪' }
    ];
        ...
        <CardContent>
          <div className="space-y-4">
            {countryData.map((country, index) => (
              <div key={country.countryCode} className="flex items-center justify-between p-4 bg-gray-800/40 rounded-xl border border-gray-700/40">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center justify-center w-8 h-8 bg-gray-700/50 rounded-lg text-sm font-bold text-gray-300">
                    #{index + 1}
                  </div>
