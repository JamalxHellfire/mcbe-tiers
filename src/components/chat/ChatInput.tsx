    ...
    <div className="p-3 bg-black/20 backdrop-blur-sm border-t border-white/10">
      <div className="flex gap-2">
        <Input
          ...
          placeholder={hasKnowledgeBase ? "Ask me anything about your document..." : "Chat about MCBE TIERS..."}
      ...
      {!hasKnowledgeBase && (
        <p className="text-xs text-white/60 mt-2 text-center">Upload a document in Admin Tools for detailed stats!</p>
      )}
    </div>
  );
}
