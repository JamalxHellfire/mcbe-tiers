    ...
    <div className="flex space-x-2 overflow-x-auto pb-1 no-scrollbar">
      {gameModes.map(mode => (
        <button
          ...
          className={cn(
            "flex items-center justify-center px-4 py-2 text-sm font-semibold rounded-lg whitespace-nowrap border transition-colors duration-150",
            mode.id === 'overall' ? "text-base px-4 py-2" : "text-sm",
            currentMode === mode.id 
